...
* Previous unpublished work has demonstrated that population pharmacokinetic (PK) modelling coupled with Bayesian estimation can forecast an individual’s PK profile based on 1 PAC observation, and forecasts can be used to predict if an individual requires NAC or not
